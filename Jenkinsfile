pipeline {
   ...
   stages {
      ...
      stage ('Build') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'build of GunGame failed', body: 'build of GunGame failed'
              }
          }
      }
      ...
      stage ('Upload') {
        steps {
            ...
            sh "/srv/hudson/upload_game.sh ${env.BUILDTYPE} target 1 GunGame MGGunGame-Plugin"
      	}
      }
      ...
      stage ('Deploy') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'deploy of GunGame failed', body: 'deploy of GunGame failed'
              }
          }
      }
   }
